...
public class Dnevnik {
    ...
    public Dnevnik(int id, String idKorime, Date stored, String url, String vrsta, String ip_adresa) {
        this.id = id;
    ...
    public String getIdKorime() {
        return idKorime;
    }

    public void setIdKorime(String idKorime) {
        this.idKorime = idKorime;
    }
